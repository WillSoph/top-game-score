  ...
  if (step === 'choose') {
    return (
      <div className="space-y-3">
        <h2 className="font-semibold text-slate-200 text-base sm:text-lg">{t('home.modal.title')}</h2>
